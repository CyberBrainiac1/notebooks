#!/usr/bin/env python
"""Benchmark a Pranav Ollama model on clean + misspelled profile questions."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate a Pranav Ollama model on clean and misspelled questions."
    )
    parser.add_argument("--model", type=str, default="pranav-assistant-pro:latest")
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.2,
        help="Generation temperature for evaluation.",
    )
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Optional JSON path for writing full results.",
    )
